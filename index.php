  ...
  <div class="row videos">
    ...
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/pWD_r9Znipk?enablejsapi=1" frameborder="0"
    ...
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/gyFLbviyUys?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/IZfEbXRXt9c?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/96XuQZPov74?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/6NiOX__IYKs?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/jlN7E1X3mfQ?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/mPgOG5Smb9o?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/M4LVn2MU6BA?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/Qmu2uKhRtls?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/OHWL14EQOcc?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/4J2ZcZG891w?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-3">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="youtube-player" src="https://www.youtube.com/embed/EkX5W7Qe6jA?enablejsapi=1" frameborder="0"
          allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
    </div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        <img class="img-responsive" src="/assets/images/PutsMarieMusiqueImprovisee-front.png"
          alt="PUTS MARIE Musique improvisee" />
        <h3>PUTS MARIE Musique improvisee</h3>
        <p>2LP<br />
          12 June 2022</p>
        <div class="order">
          <a title="Buy Love Boat 2 ||" class="buy" target="_blank"
            href="https://plattfon.ch/PUTS-MARIE-Musique-improvisee">Buy</a>
        </div>
      </div>
    </div>
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        ...
        <p>Casette + Streaming + Download<br />
          17 March 2022</p>
        <div class="order">
          <a title="Le Drame Du Pastis" class="buy" target="_blank"
            href="https://putsmarietape.bandcamp.com/album/le-drame-du-pastis">Buy</a>
        </div>
      </div>
    </div>
    <div class="col-md-3 bounce-up animation-element">
    ...
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        ...
        <p>CD / LP & Digital Download<br />
          28 September 2018</p>
        <div class="order">
          <a title="Buy Catching Bad Temper ||" class="buy" target="_blank"
            href="https://www.twogentlemen.net/products/catching-bad-temper/">Buy</a>
        </div>
      </div>
    </div>
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        ...
        <p>CD / LP & Digital Download<br />
          25 September 2015</p>
        <div class="order">
          <a title="Buy Masoch ||" class="buy" target="_blank"
            href="https://www.twogentlemen.net/products/masoch-i-ii/">Buy</a>
        </div>
      </div>
    </div>
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        ...
        <div class="order">
          <a title="Buy Masoch ||" class="buy" target="_blank"
            href="https://www.twogentlemen.net/products/masoch-ii/">Buy</a>
        </div>
      </div>
    </div>
    <div class="col-md-3 bounce-up animation-element">
    ...
    <div class="col-md-3 bounce-up animation-element">
      <div class="subject">
        ...
        <div class="order">
          <a title="Buy Masoch ||" class="buy" target="_blank"
            href="https://www.twogentlemen.net/products/pornstar/">Buy</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <center>
        <p style="margin-top: 50px;"><a title="Shop only for france" class="buy france" target="_blank"
            href=" http://www.wiseband.com/yo/shop.php?boutique=5501">Online shop france</a></p>
      </center>
    </div>
  </div>
    ...
    <div class="col-md-3 col-xs-6 bounce-up animation-element">
      <div class="subject">
        <a target="_blank" href="https://fondation-suisa.ch/">
          <img class="img-responsive" src="/assets/images/logos/fondation_suisa_standard.png">
        </a>
      </div>
    </div>
    <div class="col-md-3 col-xs-6 bounce-up animation-element">
      <div class="subject">
        <a target="_blank" href="https://www.biel-bienne.ch">
          <img class="img-responsive" src="/assets/images/logos/BielBienne_Kultur.jpg">
        </a>
      </div>
    </div>
    <div class="col-md-3 col-xs-6 bounce-up animation-element">
      <div class="subject">
        <a target="_blank" href="https://www.interpretenstiftung.ch/">
          <img class="img-responsive" src="/assets/images/logos/SIS_Logo_2014.png">
        </a>
      </div>
    </div>
    <div class="col-md-3 col-xs-6 bounce-up animation-element">
      <div class="subject">
        <a target="_blank" href="https://www.swisslos.ch">
          <img class="img-responsive" src="/assets/images/logos/SL_KtBE_Kultur_d_4f.jpg">
        </a>
      </div>
    </div>
